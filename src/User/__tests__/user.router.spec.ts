...
import CreateConnection from '../../theforceBE/database';
...
describe('User', () => {
    ...
    beforeAll(async () => {
        ...
        await connection.query('DROP TABLE IF EXISTS STOCKS_LOG');
        await connection.query('DROP TABLE IF EXISTS DOCUMENTS_LOG');
        await connection.query('DROP TABLE IF EXISTS DEPOSITS_LOG');
        await connection.query('DROP TABLE IF EXISTS PRODUCTS_LOG');
        await connection.query('DROP TABLE IF EXISTS ENTITIES_LOG');
        await connection.query('DROP TABLE IF EXISTS USERS_LOG');

        await connection.query('DROP TABLE IF EXISTS STOCKMOVEMENT');
        await connection.query('DROP TABLE IF EXISTS STOCKS');
        await connection.query('DROP TABLE IF EXISTS DOCUMENTS_PRODUCTS');
        await connection.query('DROP TABLE IF EXISTS DOCUMENTS');
        await connection.query('DROP TABLE IF EXISTS DEPOSITS');
        await connection.query('DROP TABLE IF EXISTS PRODUCTS');
        await connection.query('DROP TABLE IF EXISTS ENTITIES');
